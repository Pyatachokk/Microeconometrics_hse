...
v_gradient_0 <- matrix(c(sigma2_mle_0 * exp(mu_mle_0), 2 * sqrt(sigma2_mle_0) * exp(mu_mle_0)), ncol = 1)
v_gradient_1 <- matrix(c(sigma2_mle_1 * exp(mu_mle_1), 2 * sqrt(sigma2_mle_1) * exp(mu_mle_1)), ncol = 1)
